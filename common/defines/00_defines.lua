...
NMilitary = {
	...
	ARMY_LEADER_XP_GAIN_PER_UNIT_IN_COMBAT = 0.4, -- XP gain per unit in combat
	CONSTANT_XP_RATIO_FOR_MULTIPLE_LEADERS_IN_SAME_COMBAT = 0.7, -- if there are multiple leaders in same combat, each one gets thisratio + (1-thisratio)/num leaders. amount of xp each general gets scales 1 0.75 0.66 etc for 1 2 3 generals
	BASE_LEADER_TRAIT_GAIN_XP = 0.55,			   -- Base xp gain for traits per hour for armies
...
NAir = {
	...
	AIR_WING_MAX_SIZE = 100, 							-- Max amount of airplanes in wing
	...
	BIGGEST_AGILITY_FACTOR_DIFF = 5.0,					-- biggest factor difference in agility for doing damage (caps to this)
	...
	COMBAT_BETTER_AGILITY_DAMAGE_REDUCTION = 0.40, 		-- How much the better agility (than opponent's) can reduce their damage to us.
	...
	COMBAT_MAX_WINGS_AT_GROUND_ATTACK = 500,	        	-- we can really pounce a land strike and escalate
	...
	CLOSE_AIR_SUPPORT_EXPERIENCE_SCALE = 0.0006,		-- How much the experinence gained by CAS is scaled
	...
	CAPACITY_PENALTY = 3,								-- scales penalty of having overcrowded bases.
	...
	AIR_WING_COUNTRY_XP_FROM_TRAINING_FACTOR = 0.03, 					--Factor on country Air XP gained from wing training
...
NRailwayGun = {
	...
	ATTACK_TO_BOMBARDMENT_MODIFIER_FACTOR = 0.8,	-- Bombardment modifier is calculated by multiplying railway gun attack value with this and dividing by 100
...
NAI = {
	...
	LAND_COMBAT_CAS_PLANES_PER_ENEMY_ARMY_LIMIT = 400,	-- Limit of CAS planes requested by enemy armies
